...
public class FoundationsMain extends Application {
	...
	**********************************************************************************************/
	...
	public static PostListStorage postStorage;
	public static ReplyListStorage replyStorage;
	...
	public void start(Stage theStage) {
		...
		// Initialize discussion system storage (posts and replies)
		postStorage = new PostListStorage();
		replyStorage = new ReplyListStorage(postStorage);
