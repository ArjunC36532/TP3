...
public class ViewRole1Home {
	...
	private ViewRole1Home() {
		...
		button_CreatePost.setOnAction((_) -> {ControllerRole1Home.performCreatePost(); });
		setupButtonUI(button_ViewPost, "Dialog", 14, 100, Pos.CENTER, 140, 142);
		button_ViewPost.setOnAction((_) -> {ControllerRole1Home.performViewPost(); });
		setupButtonUI(button_Refresh, "Dialog", 14, 80, Pos.CENTER, 250, 142);
		button_Refresh.setOnAction((_) -> {ControllerRole1Home.performRefresh(); });
