	...
	*/
	...
	protected static void doSetupAdmin(Stage ps, int r) {
	    ...
	    if (!errMessage.equals("")) {
	        ...
	        ViewFirstAdmin.alertUsernamePasswordError.setTitle("Username is not valid! ");
	        ViewFirstAdmin.alertUsernamePasswordError.setHeaderText("Your username is not valid! ");
	        ViewFirstAdmin.alertUsernamePasswordError.setContentText(errMessage);
